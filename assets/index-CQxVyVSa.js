...
registerAbility({
  name: "Blood n Guts",
  type: "special",
  description: "At the start of a combat round, roll a die - 1-2 reduce hero speed by 1 for 1 round, 3-6 reduce enemy speed by 1 for 1 round.",
  reviewed: false,
  onRoundStart: (state, { owner }) => {
    const target = getOpponent(owner);
    const roll2 = rollDie().value;
...
registerAbility(createNoopAbility({
  name: "Sinister saps",
  description: "At the end of the round, add 1 sap. Each sap deals 1 damage to the hero, ignoring armour."
}));
registerAbility(createNoopAbility({
  name: "Blast the bile",
  description: "When hero wins round, instead of rolling for damage, destroy all saps."
}));
registerAbility(createNoopAbility({
  name: "Power pruning",
  description: "If hero wins round, instead of rolling for damage, -4 armour (enemy)."
}));
registerAbility(createNoopAbility({
  name: "Bullet storm",
  description: "If the enemy wins a round, roll a die. 4-6 - ant does not deal damage."
}));
registerAbility(createNoopAbility({
...
registerAbility(createNoopAbility({
  ...
  description: "At the start of the combat round, roll a die. 1-3 adds one larvae. Each larvae deals 1 damage ignoring armour at the end of the round."
}));
registerAbility(createNoopAbility({
  name: "Bug blaster",
...
registerAbility(createNoopAbility({
  name: "Harm or heal",
  description: "If enemy wins a round, roll a die. 1-2: +2 health (enemy, max 18), 3-6: roll for damage."
}));
registerAbility(createNoopAbility({
  name: "Blood suckers",
  description: "When enemy wins round and causes damage to the enemy, +1 health (enemy, max 30)."
}));
registerAbility(createNoopAbility({
  name: "Back to black",
...
registerAbility(createNoopAbility({
  ...
  description: "When the hero rolls the 8th 1 die (after rerolling) and they don't have the Golden mirror, the hero loses; if the enemy rolls the 8th 1 die and the hero has the Golden mirror, the hero wins."
}));
registerAbility(createNoopAbility({
  name: "Stone skin",
...
registerAbility(createNoopAbility({
  name: "Chip away",
  description: "After the start of the 5th round, instead of rolling for damage the hero can reduce armour of the enemy by 4, taking 4 damage ignoring armour."
}));
registerAbility(createNoopAbility({
  name: "Titan stone",
  description: "At the start of round 5, enemy is immune to all passive damage."
}));
registerAbility(createNoopAbility({
  name: "Feeding time",
  description: "Every 3 rounds, if Roots are still alive hero receives 15 damage. Roots restore full health (even when defeated)."
}));
registerAbility(createNoopAbility({
  name: "Undead",
...
registerAbility(createNoopAbility({
  name: "Corpse dance",
  description: "If Gairn's health is reduced to 25 or less, Gairn removes all passive effects and hides."
}));
registerAbility(createNoopAbility({
  name: "Army",
...
registerAbility(createNoopAbility({
  ...
  description: "If the hero wins a round, instead for rolling for damage: -1 speed -1 magic -1 armour (enemy, min speed 9, min magic armour 6)"
}));
registerAbility(createNoopAbility({
  name: "Pound those pillars",
  description: "When destroyed, -4 armour (Stone giant), 6 damage (hero)"
}));
registerAbility(createNoopAbility({
  name: "Spinning saw",
  description: "At the end of each round, roll a die. 1-2: -4 health (hero), 3-6: -4 health (Soldiers)"
}));
registerAbility(createNoopAbility({
  name: "Wood and metal",
...
registerAbility(createNoopAbility({
  name: "Flame wrapper",
  description: "At the start of the combat round, roll a die. 1-3: +1 brawn (enemy)"
}));
registerAbility(createNoopAbility({
  name: "It's behind you",
  description: "At the end of the combat round, roll a die. 1-2: 10 damage (hero)"
}));
registerAbility(createNoopAbility({
  name: "Razor beak",
...
registerAbility(createNoopAbility({
  name: "Power cubed",
  description: "When all cubes are alive, roll 3 damage dice."
}));
registerAbility(createNoopAbility({
  name: "Snake cube",
  description: "Venom (Totem)"
}));
registerAbility(createNoopAbility({
  name: "Spider cube",
...
registerAbility(createNoopAbility({
  ...
  description: "3 damage dice for highest value"
}));
registerAbility(createNoopAbility({
  name: "Backshot barrage",
  description: "At the end of round, take a speed challenge. 1-14: 10 damage (hero)"
}));
registerAbility(createNoopAbility({
  name: "Animal attraction",
  description: "If you have the rhinosaur pheromone & the rhinosaur has been freed from its cage, instead of rolling for damage: -4 health * every rd (enemy)"
}));
registerAbility(createNoopAbility({
  name: "Survival of the fittest",
  description: "Immune to Strength in Numbers"
}));
registerAbility(createNoopAbility({
  name: "Body or iron",
...
registerAbility(createNoopAbility({
  name: "Feral frency",
  description: "+1 speed * rd (enemy, max 14)"
}));
registerAbility(createNoopAbility({
  name: "Grappling grubs",
  description: "Damage (hero) -> roll a die. 1-3: -1 speed (hero)"
}));
registerAbility(createNoopAbility({
  name: "It's `lectric",
  description: "If not Insulated, -(2 + armour) health (hero)"
}));
registerAbility(createNoopAbility({
  name: "Pack attack",
...
registerAbility(createNoopAbility({
  ...
  description: "Each time a speed or combat ability is played, roll a die. 1-4: -4 health (hero), ability is skipped"
}));
registerAbility(createNoopAbility({
  name: "Slipstream",
  description: "Hero wins speed, roll a die: 1-3: -4 health (hero), skip to passive phase"
}));
registerAbility(createNoopAbility({
  name: "Rock fists",
  description: "+2 speed (enemy), 2 damage dice"
}));
registerAbility(createNoopAbility({
  name: "Arratoch alarm",
  description: "-2 brawn * rd (hero), -2 magic * rd (hero)"
}));
registerAbility(createNoopAbility({
...
registerAbility(createNoopAbility({
  name: "Golem need",
  description: "If both Otum and Atum are dead, hero wins fight"
}));
registerAbility(createNoopAbility({
  name: "Brotherly love",
  description: "If Atum is dead: +2 speed (Olum), +4 brawn (Olum)"
}));
registerAbility(createNoopAbility({
  name: "Golem protector",
  description: "When winning a round the hero can choose to Attack Arratoch instead"
}));
registerAbility(createNoopAbility({
  name: "Rock bluff",
  description: "+2 armour * rd. When hero wins round instead of rolling for damage: 7 armour (enemy)"
}));
registerAbility(createNoopAbility({
  name: "Septic seepage",
  description: "-rd health * rd (hero)"
}));
registerAbility(createNoopAbility({
  name: "Sniper fire",
  description: "At the end of the round roll a die. 1-3: -3 health (hero), 4-6: -3 health (enemy)"
}));
registerAbility(createNoopAbility({
  name: "Leaf blades",
  description: "Piercing"
...
registerAbility(createNoopAbility({
  name: "Angry mob",
  description: "Speed challenge @ end of round. 1-16: -5 health (hero)"
}));
registerAbility(createNoopAbility({
  name: "Bark whip",
  description: "For each 1 hero rolls for speed: -4 health"
}));
registerAbility(createNoopAbility({
  name: "Rune master",
  description: "Roll a die @ end of round. 1-2: +4 health (enemy), 3-4: -armour health (hero), 5-6: -2 speed * 1 rd (hero), unless hero is Hexed"
}));
registerAbility(createNoopAbility({
  name: "Blistering heat",
  description: "-1 health (hero), unless hero has Fire Shield"
}));
registerAbility(createNoopAbility({
  name: "Fan the flames",
  description: "Once, when reduced to <=20 health, roll a die: 1-2: +10 health, +3 magic (enemy), 3-4: +5 health (enemy), 5-6: +3 magic (enemy). If hero has Wind Breaker, 2 is addded to the die roll"
}));
registerAbility(createNoopAbility({
  name: "Forge master",
  description: "If hero has Fire Quencher: 30 health (enemy)"
}));
registerAbility(createNoopAbility({
  name: "Hunger strike",
  description: "Hero takes damage, roll a die. 1: Proceded, 2-6: +4 health (enemy, max 100), repeat max 6 times)"
}));
registerAbility(createNoopAbility({
  name: "Unstoppable feast",
  description: "If hero loses round, no abilities can be used for the remainder of the round"
}));
registerAbility(createNoopAbility({
  name: "Companions' courage",
  description: "+2 damage (hero)"
